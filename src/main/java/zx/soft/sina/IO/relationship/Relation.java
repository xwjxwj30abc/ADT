...
public class Relation {
	...
	public static void main(String[] args) {
		...
		//List<Comments> comments = Relation.getComments("3905364770682830", api, "3845272542");//3194139109
		for (int i = 0; i < 30; i++) {
			List<Comments> reposts = Relation.getReposts("3905364770682830", api, "3194139109");//3194139109 861 461
