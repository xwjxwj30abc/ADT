...
public class Relation {
	...
	private static List<Comments> comments = new ArrayList<>();
	...
	public static void main(String[] args) {
		...
		List<Weibo> weibos = Relation.getWeibos("李小鹏", "3194139109", api);
		System.out.println(weibos.get(0).getId());
		List<Comments> comments = Relation.getComments(weibos.get(0).getId(), api, "3194139109");
